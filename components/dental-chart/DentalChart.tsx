...
export function DentalChart({ patientId, patientName, onClose }: DentalChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full font-sans">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 px-5 py-3.5 flex flex-wrap items-center justify-between gap-3 text-white select-none shrink-0 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-sm font-bold tracking-wider uppercase">Clinical Odontogram</h3>
              <span className="text-[10px] font-mono bg-indigo-500/30 text-indigo-200 px-2 py-0.5 rounded-full border border-indigo-400/30 font-semibold">
                MolarPlus v2.0
              </span>
            </div>
            <p className="text-[11px] text-slate-300 font-medium">
              FDI ISO 3950 Anatomical 2-Part Odontogram • {patientName}
            </p>
          </div>
        </div>
      ...
      <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between overflow-y-auto space-y-4">
        
        {subView === "soft-tissue" ? (
          /* ── Soft Tissue Examination Sub-View ── */
          <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50 rounded-2xl border border-slate-200 text-center space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl w-full pt-2">
              {["Labial Mucosa", "Buccal Mucosa", "Hard & Soft Palate", "Tongue & Floor of Mouth"].map((tissue) => (
                <div key={tissue} className="p-3 bg-white rounded-xl border border-slate-200 shadow-2xs text-left">
                  <span className="text-[11px] font-bold text-slate-700 block">{tissue}</span>
                  <span className="text-[10px] text-emerald-600 font-semibold flex items-center gap-1 mt-1">
                    <CheckCircle2 className="w-3 h-3" /> Normal / Healthy
                  </span>
                </div>
              ))}
            </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50 rounded-2xl border border-slate-200 text-center space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-indigo-100 border border-indigo-300 flex items-center justify-center text-indigo-700">
              <Activity className="w-7 h-7" />
            </div>
            <div>
              <h4 className="text-base font-bold text-slate-800">
          ...
          <div className="flex-1 flex flex-col justify-center overflow-x-auto py-2">
            <div className="min-w-[680px] mx-auto flex flex-col items-center gap-4 select-none">
              
              {/* Quadrant Header Guides (Upper Jaw) */}
              <div className="w-full flex items-center justify-between text-[11px] font-bold text-slate-400 px-4 uppercase tracking-wider">
              ...
              <div className="flex items-end justify-center gap-2 relative bg-slate-50/50 p-3 rounded-2xl border border-slate-100">
                ...
                <div className="w-px self-stretch bg-indigo-300 mx-1 sm:mx-2 flex-shrink-0 relative group">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[9px] font-mono font-bold px-1.5 py-0.2 rounded shadow-xs">
                    MIDLINE
                  </div>
                </div>
              ...
              <div className="w-full flex items-center gap-4 my-1">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
              ...
              <div className="flex items-start justify-center gap-2 relative bg-slate-50/50 p-3 rounded-2xl border border-slate-100">
                ...
                {/* Vertical Midline Axis Divider */}
                <div className="w-px self-stretch bg-indigo-300 mx-1 sm:mx-2 flex-shrink-0 relative group">
                  <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[9px] font-mono font-bold px-1.5 py-0.2 rounded shadow-xs">
                    MIDLINE
                  </div>
                </div>
              ...
              {/* Quadrant Header Guides (Lower Jaw) */}
              <div className="w-full flex items-center justify-between text-[11px] font-bold text-slate-400 px-4 uppercase tracking-wider">
        ...
        <div className="border-t border-slate-100 pt-3 flex flex-wrap items-center justify-between gap-3 text-xs shrink-0 select-none">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <span className="w-3.5 h-3.5 rounded-sm bg-amber-400 border border-amber-500" />
              <span>Planned</span>
            ...
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <span className="w-3.5 h-3.5 rounded-sm bg-blue-600 border border-blue-700" />
            ...
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <span className="w-3.5 h-3.5 rounded-sm bg-orange-600 border border-orange-700" />
            ...
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <span className="w-3.5 h-3.5 rounded-sm bg-rose-500 border border-rose-600" />
              <span>Extracted</span>
            ...
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <span className="w-3.5 h-3.5 rounded-sm bg-red-600 border border-red-700" />
              <span>Caries</span>
          ...
          <div className="flex items-center gap-2">
            {selectedTooth && (
              <button
                type="button"
                onClick={closeTooth}
                className="px-3 py-1 text-slate-500 hover:text-slate-800 text-xs font-semibold rounded-lg hover:bg-slate-100 transition-colors cursor-pointer"
              >
                Deselect Tooth
              </button>
            )}
            {onClose && (
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-1.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-lg transition-colors cursor-pointer shadow-sm"
              >
                Done
              </button>
            )}

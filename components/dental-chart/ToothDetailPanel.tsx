...
export function ToothDetailPanel({ onSaveTreatment, isSaving }: ToothDetailPanelProps) {
  ...
  return (
    <div className="w-full lg:w-[420px] flex flex-col bg-white border-l border-slate-200 h-full overflow-hidden shadow-2xl shrink-0 font-sans z-30">
      
      {/* ─── A. HEADER & ANATOMICAL PREVIEW CARD ─── */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 px-5 py-4 text-white shrink-0 shadow-md">
      ...
      <div className="flex border-b border-slate-200 bg-slate-50 px-2 pt-1 shrink-0">
        ...
        >
          ...
          History ({selectedTooth.record?.treatments?.length || 0})
        </button>
        <button
          type="button"
        ...
        >
          ...
          Plans ({selectedTooth.record?.plans?.length || 0})
        </button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {panelTab === "history" ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-50/70 p-3.5 rounded-xl border border-slate-200 flex flex-col gap-3">
              <div className="flex items-center gap-4">
                {/* Anatomical Mini Profile */}
                <div className="w-16 h-20 flex items-center justify-center bg-white rounded-lg border border-slate-200 p-1 shrink-0 shadow-2xs">
                  <ToothSvg
                    type={
                      toothNumber % 10 === 8
                        ? "wisdom"
                ...
                {QUICK_STATUS_CHIPS.map((chip) => {
                  ...
                  return (
                    <button
                      ...
                      className={`py-1.5 px-2 rounded-lg text-xs font-bold transition-all cursor-pointer border text-center select-none ${
                        isActive
                          ? chip.activeClass
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 pr-8 rounded-lg border border-slate-200 bg-white text-xs font-medium text-slate-800 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                  />
              ...
              <div className="relative">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[10px] text-slate-400">Auto-fills estimated fee</span>
                </div>
                <div className="relative">
                  <input
                    id="input-procedure"
                    ...
                    placeholder="e.g. Root Canal Treatment, Composite Restoration"
                    className="w-full px-3 py-2 pr-8 rounded-lg border border-slate-200 bg-white text-xs font-medium text-slate-800 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                  />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-7 pr-3 py-2 rounded-lg border border-slate-200 bg-white text-xs font-medium text-slate-800 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white text-xs font-medium text-slate-800 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. Sensitivity to cold, 2 canals obturated, MB2 located..."
      ...
      <div className="p-4 bg-slate-50 border-t border-slate-200 shrink-0 space-y-2">
        <button
          ...
          className="w-full py-2.5 px-4 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white text-xs font-bold rounded-xl transition-all cursor-pointer shadow-sm flex items-center justify-center gap-2 disabled:opacity-50"
        >
          {isSaving ? (
            <>
